...
<body>
    ...
    <div class="container mt-4">
        <div class="text-center mb-4"
             style="background-image: url('<?php echo e(Vite::asset('resources/images/header.png')); ?>'); background-size: cover; background-position: center; padding: 400px;">
        </div>
    </div>

        <div class="content text-center">
            <img src="<?php echo e(Vite::asset('resources/images/logo w2e.png')); ?>" alt="Logo Wave to Earth" class="band-logo">
            <h1>Hi!</h1>
            <h1>We are</h1>
            <h1>Wave to Earth</h1>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card h-100">
                    <img src="<?php echo e(Vite::asset('resources/images/light.png')); ?>" class="card-img-top" alt="Light">
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card h-100">
                    <img src="<?php echo e(Vite::asset('resources/images/calla.png')); ?>" class="card-img-top" alt="Calla">
                    <div class="card-body text-center">
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card h-100">
                    <img src="<?php echo e(Vite::asset('resources/images/nouvelle vague.png')); ?>" class="card-img-top" alt="Nouvelle Vague">
                    <div class="card-body text-center">
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card h-100">
                    <img src="<?php echo e(Vite::asset('resources/images/daisy.png')); ?>" class="card-img-top" alt="Daisy">
                    <div class="card-body text-center">
...
<?php /**PATH D:\Kuliah\Semester 3\Modul 11\modul11\resources\views/tugas.blade.php ENDPATH**/ ?>