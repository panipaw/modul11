...
<body>
    <div class="container m-5">
        ...
        <div class="list-group list-group-numbered mt-4">
            <a href="<?php echo e(url('/tugas')); ?>" class="list-group-item list-group-item-action">
                tugas
            </a>
        </div>
...
<?php /**PATH D:\Kuliah\Semester 3\Modul 11\modul11\resources\views/routing.blade.php ENDPATH**/ ?>